...
export class ActiveSessionComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.socketService.send(
      new GetPointSchemaOptionsMessage({ sessionId: this.session.sessionId })
    );
  ...
  private setSessionName = (messageData: GetSessionNameMessage) => {
    ...
    this.pointValues = messageData.payload.schemeValues;
  ...
  private handleEvents = (messageData: SpMessage) => {
    ...
    switch (eventType) {
      ...
      case Events.PARTICIPANT_REMOVED:
        ...
        break;
      case Events.GET_SESSION_NAME: // and point scheme values for the time being
      ...
      case Events.SHAME_TIMER_ENDED:
        ...
        break;
      case Events.GET_POINT_SCHEMA_OPTIONS:
        this.setPointSchemeOptions(messageData as any);
        break;
  ...
  private setPointSchemeOptions = (messageData: any) => {
    this.pointSchemeOptions = messageData.payload.pointSchemes;
